...
const Cells = ["name","email","date d'ajout","action"]

export default function ResLivraison() {
  ...
  return (
      <div className="px-lg-4 px-xl-5 container-fluid">
          <Wrapper
              Title = "Responsable de livraison"
              Breadcrumb = "responsable de livraison" 
          />
          <SearchBar 
              Title="Chercher un responsable de livraison"
              btn="Chercher"
          />
