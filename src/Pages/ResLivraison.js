...
const Cells = ["id","name","email","date d'ajout","action"]
...
function ResLivraison() {
    ...
    function getdata() {
        axios("http://localhost:4000/api/ResLivraison/")
        .then((result)=> {
            setData(result.data)
        })
    }
    ...
    function save(){
        axios
            .post(`http://localhost:4000/api/ResLivraison/add`,{
                name:name,
                email:email,
            })
            .then(res=>{
    ...
    function deleteRow() {
        axios
            .delete(`http://localhost:4000/api/ResLivraison/${dataId}`)
            .then(res=>{
                console.log(res);
                setDOpen(false)
                getdata()
    ...
    function updateData(){
        axios
            .put(`http://localhost:4000/api/ResLivraison/${dataId}`,{
                name:name,
                email:email,
            })
            .then(res=>{
            ...
            >
                ...
                <div className='header-btn'>
                    <Typography id="modal-modal-title" style={{ fontSize:"16px", marginTop:"6px" }}  variant="h6" component="h1">
                        Ajouter un responsable de livraison
                    </Typography>
